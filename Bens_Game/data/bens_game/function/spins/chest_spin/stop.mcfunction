execute at @e[type=armor_stand,name=chestSlot] run data merge block ~ ~1 ~ {Items:[{Slot:0b,id:"minecraft:golden_chestplate",count:1},{Slot:1b,id:"minecraft:iron_chestplate",count:1},{Slot:2b,id:"minecraft:diamond_chestplate",count:1}]}
...
tag @e[type=armor_stand,name=chestSlot] remove running
