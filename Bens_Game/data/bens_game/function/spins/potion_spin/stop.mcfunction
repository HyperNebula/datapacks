execute at @e[type=armor_stand,name=potionSlot] run data merge block ~ ~1 ~ {Items:[{Slot:0b,id:"minecraft:potion",count:1},{Slot:1b,id:"minecraft:potion",count:1},{Slot:2b,id:"minecraft:potion",count:1}]}
