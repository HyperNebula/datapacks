...
execute at @e[type=armor_stand,name=secondarySlot] run tp @e[type=item,tag=temp_give_secondary_item,limit=1] @e[tag=secondary_give,limit=1]

tag @a remove secondary_give
