...
summon item 0 0 0 {Tags:["temp_give_block_item"], Item:{id:"minecraft:stone", count:1}}
...
execute at @e[type=armor_stand,name=blockSlot] run tp @e[type=item,tag=temp_give_block_item,limit=1] @p
