#gunpowder
execute at @e[type=armor_stand,name=500slot1] run execute if items block ~ ~1 ~ container.0 minecraft:feather run clear @s minecraft:iron_nugget[custom_name="100 chip"] 3
