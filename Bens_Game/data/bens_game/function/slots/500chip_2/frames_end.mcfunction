...
summon item 0 0 0 {Tags:["temp_give_500CHIP2_item"], Item:{id:"minecraft:stone", count:1}}
execute at @e[type=armor_stand,name=500Slot2] run data modify entity @e[type=item,tag=temp_give_500CHIP2_item,limit=1] Item set from block ~ ~1 ~ Items[{Slot:0b}]
execute at @e[type=armor_stand,name=500Slot2] run tp @e[type=item,tag=temp_give_500CHIP2_item,limit=1] @p
