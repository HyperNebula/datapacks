#gunpowder
execute at @e[type=armor_stand,name=5Slot2] run execute if items block ~ ~1 ~ container.0 minecraft:gunpowder run clear @s minecraft:copper_nugget[custom_name="5 chip"] 5
