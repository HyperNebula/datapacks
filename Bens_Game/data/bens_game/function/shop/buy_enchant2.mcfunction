advancement revoke @s only bens_game:shop/interact_enchant2
execute store result score @s held_amount run data get entity @s SelectedItem.count
execute if items entity @s weapon.mainhand minecraft:iron_nugget if score @s held_amount matches 3.. run function bens_game:shop/process_buy_enchant2
