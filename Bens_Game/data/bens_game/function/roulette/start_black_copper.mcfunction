...
execute as @e[name=roulette_marker,limit=1] run tag @p add roulette_player_black_copper
tag @e[name=roulette_marker] add running


execute at @e[name=roulette_marker] run clear @p[tag=roulette_player_black_copper] minecraft:copper_nugget 5
