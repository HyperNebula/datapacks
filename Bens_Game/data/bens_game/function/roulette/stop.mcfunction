...
execute at @e[name=roulette] run tag @a[tag=roulette_player_black] remove roulette_player_black
execute at @e[name=roulette] run tag @a[tag=roulette_player_red] remove roulette_player_red
