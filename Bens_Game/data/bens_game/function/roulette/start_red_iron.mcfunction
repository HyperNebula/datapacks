execute as @e[name=roulette_marker,limit=1] run tag @p add roulette_player_red_iron
tag @e[name=roulette_marker] add running

execute as @e[name=roulette_marker] run clear @p[tag=roulette_player_red_iron] minecraft:iron_nugget 1
