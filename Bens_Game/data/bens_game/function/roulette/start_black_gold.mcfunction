...
execute as @e[name=roulette_marker,limit=1] run tag @p add roulette_player_black_gold
tag @e[name=roulette_marker] add running


execute as @e[name=roulette_marker] run clear @p[tag=roulette_player_black_gold] minecraft:gold_nugget 1
