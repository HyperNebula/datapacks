...
execute at @e[tag=portal1] as @a[distance=..2] unless score @s portal_delay matches 1.. run tag @s add tp_to_2
...
execute at @e[tag=portal2] as @a[distance=..2] unless score @s portal_delay matches 1.. run tag @s add tp_to_1
