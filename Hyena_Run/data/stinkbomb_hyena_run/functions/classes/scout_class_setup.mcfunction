item replace entity @s splash_potion{display:{Name:'{"text":"Crack","color":"green","bold":true,"italic":true,"underlined":true}'},HideFlags:34,CustomPotionEffects:[{Id:2,Amplifier:3b,Duration:140,ShowParticles:0b},{Id:9,Amplifier:20b,Duration:240,ShowParticles:0b},{Id:33,Amplifier:20b,Duration:240,ShowParticles:0b}]} 1
...
item replace entity @s armor.legs with leather_tunic{display:{color:1113864},Unbreakable:1b} 1
item replace entity @s armor.feet with leather_boots{display:{color:1113864},Unbreakable:1b} 1
...
item replace entity @s hotbar.8 with minecraft:firework_rocket{display:{Name:'{"text":"Rocket Science","color":"green","bold":true,"italic":true,"underlined":true}'},HideFlags:4,Unbreakable:1b} 64
item replace entity @s hotbar.6 with barrel{display:{Name:'{"text":"Barrel","color":"green","bold":true,"italic":true,"underlined":true}'}} 1
