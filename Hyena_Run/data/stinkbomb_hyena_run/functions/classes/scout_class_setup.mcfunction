...
item replace entity @s armor.chest with elytra{HideFlags:4,Damage:422} 1
...
item replace entity @s inventory.2 with bucket{display:{Name:'{"text":"Bucket","color":"green","bold":true,"italic":true,"underlined":true}'}} 1
